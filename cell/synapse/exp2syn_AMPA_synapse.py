...
class Exp2syn_AMPA(NeuronSynapse): 
    
    def __init__(self, additional_parameters={}):
        super(self.__class__, self).__init__()
        
        self.name = "exp2syn_AMPA"
        self.strength = 0.0003
        self.tau1 = 0.2 # from Hausser and Roth 1997
        self.tau2 = 1.7 # from Hausser and Roth 1997
